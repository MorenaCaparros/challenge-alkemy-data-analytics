...
museos = 'https://datos.cultura.gob.ar/dataset/37305de4-3cce-4d4b-9d9a-fec3ca61d09f/resource/01c6c048-dbeb-44e0-8efa-6944f73715d7/download/biblioteca_popular.csv'
...
def cc(archive_name):
    with open(archive_name, encoding='utf-8') as archivo:
        next(archivo)
        alumnos = []
        
try:
    separador = ','
    r = requests.get(museos)
    cc(r)
